...
export default function MessageInput() {
    ...
    const { chattingWith, setCurrentMessageList, setChatPool, setUpdateChatSideBar, updateChatSideBar, setOfflineMessages, lastChatWith, setLastChatWith } = useContext(ChatContext);
    ...
    return (
        <div className="messageInputContainer">
            <input type="text" className="messageBodyInput" onChange={(e) => setMessage(e.target.value)} placeholder="type here..." value={message} name="messageBody"></input>
            <button type="submit" className="sendMessageBtn" onClick={() => sendMessage()} >Send</button>
        </div>
    )
}
